...
class PreviewPlugins extends Component<{ container: IMain }, {}> {
  ...
  __mermaidOpenExternalClick = ( event ) => {
    ...
    ipc.send ( 'mermaid-open', data ); //TODO: We should open this in the default browser instead, but it turns out that we can't open "data:*"" urls from here, perhaps we could set-up a special-purpose website to workaround this, something like https://TapNote.md/dataurl#data:image...
